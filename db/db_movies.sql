...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 02, 2018 at 01:36 AM
...
CREATE TABLE IF NOT EXISTS `tbl_user` (
  ...
  `expire_time` varchar(35) DEFAULT NULL,
  PRIMARY KEY (`user_id`)
...
INSERT INTO `tbl_user` (`user_id`, `user_fname`, `user_name`, `user_pass`, `user_email`, `user_date`, `user_ip`, `user_level`, `expire_time`) VALUES
(41, 'test', 'test', '$2y$10$nvDjIO1VH7HMCAIamZ8SB.xZ.7df0ncKgHOx.NErwVDYJln4gRf/G', 'wyao@alcanada.com', '2018-03-02 01:36:24', '::1', '2', 'unlimited');
COMMIT;
